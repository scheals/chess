...
class Pawn < Piece
  ...
  #   once_diagonal?(to_coordinate) || (once_vertical?(to_coordinate) && position.same_column?(to_coordinate)) ||
  #     (double_vertical?(to_coordinate) && position.same_column?(to_coordinate))
  # end
